...
OUTPUT_DIR = "/home/u500764/projects/svm_pearson/data_splits" 
...
print(f"训练集样本数: {len(train_subjects)}")
print(f"验证集样本数: {len(validation_subjects)}")
print(f"测试集样本数: {len(test_subjects)}")
